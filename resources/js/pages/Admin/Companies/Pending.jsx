 ...
 * Route::get('/admin/companies/pending', function () {
 *     return Inertia::render('Admin/Companies/Pending', [
 *         'auth' => [
 *             'user' => Auth::user(),
 *         ],
 *     ]);
 * })->middleware(['auth', 'verified'])->name('admin.companies.pending');
 * 
 * NOTE: This is a view-only page using mock data, no API calls are made.
 */

export default function CompaniesPending({ auth, companies = null, meta = null, filters = {} }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        console.log({ q: searchQuery, industri: industriFilter });
    ...
    if (user?.role_id !== 1) {
        return (
            ...
            >
                <Head title="Admin - Companies (Pending)" />
                <div className="py-12">
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Admin - Companies (Pending)</h2>}
        >
            <Head title="Admin - Companies (Pending)" />
                        ...
                        <div className="p-6">
                            ...
                            {displayCompanies.length > 0 ? (
                                ...
                                <div className="py-8 text-center">
                                    <p className="text-lg font-medium text-gray-700">Tidak ada perusahaan pending.</p>
                                    <p className="text-sm text-gray-500">Semua perusahaan sudah diverifikasi.</p>
                                </div>
                            )}
