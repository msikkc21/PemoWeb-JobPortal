...
export default function OnboardingCompany({ auth, company }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('company.onboarding.store'), {
            forceFormData: true,
        });
    };
                        ...
                        <div className="p-8">
                            ...
                            <div className="mb-8">
                                ...
                                <p className="text-gray-600">
                                    Lengkapi profil perusahaan Anda untuk mulai
                                    menggunakan layanan kami. Semua field
                                    ...
                                    <div className="border-b border-gray-200 pb-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="md:col-span-2">
                                                <InputLabel
                                                    htmlFor="photo_path"
                                                    value="Logo Perusahaan / Foto Profil"
                                                />
                                                <input
                                                    id="photo_path"
                                                    type="file"
